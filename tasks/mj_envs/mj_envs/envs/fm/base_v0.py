...
class FMBase(env_base.MujocoEnv):
    ...
    DEFAULT_OBS_KEYS = ["qp", "qv", "pose_err"]
    ...
    def __init__(self, model_path, **kwargs):
        ...
        processed_xml = reassign_parent(
            xml_str=raw_xml, receiver_node="panda0_link7", donor_node="DManus_mount"
        )
...
class FMReachEnvRandom(FMBase):
    def reset(self):
        self.target_pose = self.np_random.uniform(
            low=self.sim.model.actuator_ctrlrange[:, 0],
